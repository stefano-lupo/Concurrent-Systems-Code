...
#define _nstates0	37	/* philosipher */
#define minseq0	0
#define maxseq0	35
...
#define Air1	(sizeof(P1) - Offsetof(P1, j) - 1*sizeof(int))

#define Pphilosipher	((P0 *)this)
typedef struct P0 { /* philosipher */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, a) - 1*sizeof(int))
...
#define HAS_TRACK	0
/* hidden variable: */	uchar havelock[5];
/* hidden variable: */	int sume;
