...
#define PanSource	"diningPhil.pml"
...
#define _nstates1	7	/* :init: */
#define minseq1	37
#define maxseq1	42
#define _endstate1	6

#define _nstates0	38	/* P */
#define minseq0	0
#define maxseq0	36
#define _endstate0	37
...
#define Air0	(sizeof(P0) - Offsetof(P0, right) - 1*sizeof(int))
...
#define HAS_TRACK	0
/* hidden variable: */	uchar thinking[4];
/* hidden variable: */	uchar hungry[4];
/* hidden variable: */	uchar eating[4];
